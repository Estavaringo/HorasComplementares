                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li class="truncate"><a href="Executa?logicaDeNegocio=TipoComprovanteServlet&tarefa=consultarLista">Tipo de Comprovantes</a></li>
                                        <li class="truncate"><a href="Executa?logicaDeNegocio=TipoRelatorioServlet&tarefa=consultarLista">Tipo de Atividades</a></li>
                                        <li class="truncate"><a href="Executa?logicaDeNegocio=TipoContatoServlet&tarefa=consultarLista">Tipo de Contatos</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
