...
<main>    
        ...
        <div class="titulo-pagina">
            <div class="container">
                <div class="row">
                    <div class="col s12">
                        <h2 class="header center-on-small-only">Tipos de Notificação</h2>
                        <h4 class="light green-text text-lighten-4 center-on-small-only">Gerencie os tipos de notificação do sistema</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <table id="example" class="highlight responsive-table">
                <thead>
                    <tr>
                        <th data-field="tipoNotificacao">Notificação</th>
    ...
    <div id="modal-alterar" class="modal modal-fixed-footer">
        <form method="POST" action="Executa">
            <div class="modal-content">
                <h4>Alterar tipo de notificação</h4>
                <p>Altere o tipo de notificação selecionado:</p>
                ...
                <div class="input-field">
                    ...
                    <input id="descricao-alterar" placeholder="Insira o nome do tipo de notificação aqui..." type="text" class="validate" name="descricao" value="" />
                </div>
            </div>
    ...
    <div id="modal-excluir" class="modal modal-fixed-footer">
        <form method="POST" action="Executa">
            <div class="modal-content">
                <h4>Excluir tipo de notificação</h4>
                <p>Confirme a exclusão do tipo de notificação selecionado:</p>
    ...
    <div class="fixed-action-btn" style="bottom: 110px; right: 24px;">
        <a class="modal-trigger btn-floating btn-large red  tooltipped" data-position="top" data-delay="50" data-tooltip="Incluir um novo tipo de notificação" href="#modal-incluir">
    ...
    <div id="modal-incluir" class="modal modal-fixed-footer">
        <form method="POST" action="Executa">
            <div class="modal-content">
                <h4>Incluir tipo de notificação</h4>
                <p>Insira abaixo o novo tipo de notificação</p>
                ...
                <div class="input-field">
                    ...
                    <input id="descricao-incluir" placeholder="Insira o nome do tipo de notificação aqui..." type="text" class="validate" name="descricao" value="" />
                </div>               
            </div>
            <div class="modal-footer">
