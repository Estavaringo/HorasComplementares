...
<main>    
        ...
        <div class="titulo-pagina">
            <div class="container">
                <div class="row">
                    <div class="col s12">
                        <h2 class="header center-on-small-only">Relatórios</h2>
                        <h4 class="light green-text text-lighten-4 center-on-small-only">Altere os tipos de relatórios aceitos</h4>
                    </div>
                </div>
            </div>
        </div>
