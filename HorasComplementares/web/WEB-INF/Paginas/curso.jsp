...
<main>    
        ...
        <div class="container">
            <table id="example" class="highlight responsive-table">
                <thead>
                    <tr>
                        <th data-field="codigo">Código do Curso</th>
                        ...
                        <c:forEach var="curso" items="${listaCurso}">
                            <tr>
                                ...
                                <td class="hide-on-small-only">
                                    <!-- Dropdown Trigger -->
                                    <a class='dropdown-button btn-floating grey darken-2' href='#' data-constrainwidth="false" data-activates='dropdown${curso.codigo}'><i class="material-icons">menu</i></a>
                                    <!-- Dropdown Structure -->
